...
Hi! I'm **Ihyeon** — a **Cyber Security** postgraduate (MSc) with a Computer Science background, based in the UK.

- 🔐 Focused on **Cloud Security** (AWS) and secure infrastructure
- 🛠️ Comfortable with **Linux** and hands-on with building/breaking systems
- 💡 CS background means I don't just use security tools — I understand the code underneath

Always exploring ways to build safer, more resilient systems.
...
<div style="display:flex; flex-direction:row;">
    <a href="mailto:mashin0128@gmail.com">
     ...
     <a href="https://www.linkedin.com/in/ihyeon-shin/">
